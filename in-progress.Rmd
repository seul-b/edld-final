...
library(stats)
library(ggstatsplot)
library(interactions) #Moved from coding chunk to this hidden setup chunk. Best to keep all library() code together so people can easily see all the packages you used.
library(car) #Moved from coding chunk to this hidden setup chunk. Best to keep all library() code together so people can easily see all the packages you used.
```
...
#install.packages("interactions") #Keep all your library code in the setup chunk
