...
# Research Question
**Do the teacher-reported student math scores over two separate time periods (i.e., base year and first follow-up) correlate with 1) students' sex, 2) students' race/ethnicity, and 3) mother's highest education level of students?**

## SUGGESTION: Great research question! I reworded it a bit to make it a little easier to read. 
...
## QUESTION/SUGGESTION: Wow! You have a lot to work with here - super cool! I did notice, however, that the categories under each independent variable seems to be ordered in numerical order starting with 1 and then it tapers off to negative values. Sorry if I'm just missing the answer - is there a reason why -4 indicates "Nonrespondent", -8 indicates "N/A", and -9 indicates "Missing" as opposed to using other numbers for measurement? If not already stated, maybe explaining the rationale for assigning values could be helpful!
...
## STRENGTH: Your team did a great job describing the different dependent variables. Very thorough!
...
## SUGGESTION: This visualization looks so freaking awesome! There is a lot going on at once though, which may make it a little difficult to follow. Maybe it would be helpful to break up the data a little bit or reconfigure a bit so that the labels/titles are little more clear/methodical?
...
## STRENGTH: I'm so impressed with these plots, especially the Math Score by Mother Education one. It's very clear and easy to follow.
...
## LEARNED SOMETHING!: These plots are so neatly displayed. Great job! Bonus points for the way that the colors are organized - super satisfying. This is also giving me an idea to display data for my group's project, except instead of race, we're looking at age/generation.
...
## STRENGTH: Overall, I think you have a lot of great data here and interesting modes of analysis. It's obvious your group took the time to really plan out how you'll be observing and interpreting your data. Bravo!
