...
#This looks awesome! I love all of the graphs and colors! 

# I did not realize that you could use so many "#" to control size! That is awesome! I will experiment with that! 

# I would consider explaining what might be meaningful about students' change in score. What is it that you are evaluating explicitly? Perhaps ability to improve and grow as a student? 

#I would add a hypothesis that explains what you expect to find with each variable. Are there known components of your variables that lead you to predict that certain students will trend in a specific direction at the second time point?
#This will mostly come up in the write-up of course! 

# looking at an average of difference scores might be cool! It might allow a graph to have sightly less info and be easier to interpret at a glance

#Excellent use of pivot_longer to create meaningful graphs
#General organization is also very strong. The table of contents is helpful and it was great to flow through data cleaning, data visualization, and then statistics. 
...
# These Box plots need a color legend. I tried a few things that are not working. 
#Here is a website that might be helpful https://www.datanovia.com/en/blog/ggplot-legend-title-position-and-labels/
