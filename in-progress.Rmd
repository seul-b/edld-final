...
```
# Visualization 1
<!-- Great plots! I just have one question regarding visualizations 1, 2, and 3: Are these the _mean_ student math scores for each group?  -->
...
<!-- Another question: The title of the box plots says "Math Score by Race and Year, but I'm having a hard time understanding where Year is incorporated in these, especially the first one -->
...
## Density Plots
<!-- I really enjoy the organization of your density plots. The color scheme makes them a lot more intelligible -->
...
I am not sure how to do a regression analysis of all three variables, but I can look at the regression analysis of math scores based on race/ethnicity and mother's education.   
 ...
 <!--What helped me with my regression table was the {stargazer} package, which creates very neat tables and allows you to run multiple regression models side-by-side. -->
